            ...
            <SafeAreaView style={styles.container}>
                <View style={styles.textWrap}>
                    ...
                    <Text style={styles.info}>
                        Để lấy lại mật khẩu, vui lòng nhập số điện thoại của
                        bạn. Chúng tôi sẽ gửi mã xác nhận đến số điện thoại của
                        bạn. Sau đó bạn sẽ được chuyển hướng đến trang đổi mật
                        khẩu.
                    </Text>
                </View>
